...
b = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp2/2.png"),
...
c = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp3/2.png"),
...
d = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp4/2.png"),
...
e = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp5/2.png"),
...
f = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp6/2.png"),
...
g = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp7/2.png"),
...
h = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp8/2.png"),
...
j = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp9/2.png"),
...
k = Campaign.create({
  ...
  carousel_image: File.open("app/assets/images/camp10/2.png"),
